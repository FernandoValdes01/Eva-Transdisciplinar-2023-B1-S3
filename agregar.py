...
btn_prev.grid(row = 1, column = 1, padx = 50, columnspan=2, sticky='snw')
btn_next = ctk.CTkButton(main_window, text="Siguiente", command=next_part)
btn_next.grid(row = 1, column = 1, padx = 40, columnspan=2, sticky='sne' )
...
yt.grid(row = 1, column = 1, padx = 25, columnspan=2, sticky='sn')
